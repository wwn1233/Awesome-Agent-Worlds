...
- Categories: `computer-world`, `web-world`, `mobile-world`, `code-world`, `api-world`, `research-world`, `gui-world`, `embodied-world`, `generative-3d-world`, `training-framework`, `agent-infrastructure`
- Resource kinds: `world`, `benchmark`, `dataset`, `training_framework`, `agent_infrastructure`, `protocol`, `model_release`, `closed_product_signal`, `safety_control`
