...
| Post-training engineer | Claw-R1, Qwen-AgentWorld, Fara-1.5, VisCritic, Autonomous Evaluation for CUA RL | They cover step-level agentic RL records, language world models, scalable CUA environment generation, visual process rewards, and autonomous reward feedback. |
...
- OSWorld, OSWorld-Verified, macOSWorld, MacArena, MacAgentBench, GUI vs. CLI Execution Benchmark, Argus / CUA Uncertainty Quantification, AgentCIBench / Contextual Integrity, and TClone.
