...
| --- | --- | --- |
| Build agent evaluations | OSWorld-Verified, OSWorld 2.0, BrowserGym, WebArena-Verified | AndroidWorld, MacAgentBench, ChainWorld, PPT-Eval, DynamicGUIBench / DynamicUI, MCPWorld, tau-bench, D3-Gym |
...
| Audit agent safety | PhoneSafety / Safe, or Simply Incapable?, NRT-Bench, CAPED, MyPhoneBench, SkillSafetyBench | CUAHarm, RiOSWorld, CORA / Phone-Harm, OS-Harm, OS-BLIND, AgentHazard, LPS-Bench, MCP-SafetyBench, MCPSecBench, AI-Infra-Guard, ToolPrivacyBench, Web PII Leakage Benchmark |
| Study GUI/VLM agents | OSWorld, AndroidWorld, MobileGym, MCPWorld, OmniACT | OpenCUA, UI-TARS, Xiaomi-GUI-0, ATMem / STR-GRPO, MacAgentBench, GUI vs. CLI Execution Benchmark, ChainWorld, PPT-Eval, ENVS |
...
- Workflow-GYM, WeaveBench, EntWorld, MyPCBench, LabOSBench, ChainWorld, PPT-Eval, ENVS, LUMOS, DragOn, ComAct / ComCADBench, AgentHijack, OSGuard, RoTS / GUI-RobustEval, HiViG, VISUALSKILL, and Multi-Agent Computer Use for professional, hybrid-interface, enterprise GUI, personal-computer, scientific-instrument, desktop-composition, office-document, verified GUI-trajectory, semantic OS, fine-grained GUI, professional-software, corruption robustness, guardrail evaluation, GUI error recovery, history-aware GUI critic, multimodal skill, and parallel computer-use coverage.
...
- Terminal-Bench, TUA-Bench, LiteCoder-Terminal, TermiGen, and daVinci-Env.
...
- Web, mobile, and CUA safety: StakeBench, WebDecept, Web PII Leakage Benchmark, Sleeper Attack, NRT-Bench, CAPED, MIRAGE, AgentHijack, OSGuard, FATE-VLA, PhoneSafety / Safe, or Simply Incapable?, CUAHarm, RiOSWorld, CORA / Phone-Harm, SafeMCP, and MCP-SafetyBench.
