...
| 1 hour | [Resource Index](resource-index.md), [Selection Guide](selection-guide.md), [Scoring Methodology](selection-guide.md#scoring-methodology), [Hot Papers](hot-papers.md) | Understand the field axes, verifier risks, and evidence sources. |
| Using the index | [Resource Index](resource-index.md), [Scoring Methodology](selection-guide.md#scoring-methodology), [Static Explorer Guide](../../site/README.md), [Hot Papers](hot-papers.md) | Pick resources, compare evidence fields, trace weekly papers back to catalog rows, and avoid overclaiming readiness. |

## By Reader Goal

| Goal | Start here | Then read |
| --- | --- | --- |
| Build agent evaluations | OSWorld-Verified, OSWorld 2.0, OSWorld-Human, BrowserGym, WebArena-Verified | AndroidWorld, FineState-Bench, VeriGUI / Action-Effect Verification, MacAgentBench, ChainWorld, PPT-Eval, DynamicGUIBench / DynamicUI, MCPWorld, tau-bench, GameCraft-Bench, D3-Gym |
| Train from rollouts | SWE-Gym, AgentGym, AgentGym-RL, Agent-World: Scaling Real-World Environment Synthesis for Evolving General Agent Intelligence, Qwen-AgentWorld | Agent-as-Annotators, OpenMobile, TRACE / Capability-Targeted Agentic Training, Plan-RewardBench, GraphGPO, TAO-RL, COMFYCLAW, A2World, WorldEvolver, Fara-1.5, Xiaomi-GUI-0, AgentProg, UI-Voyager, PEEU / GUI Experience Exploration, Failure-Driven CUA Self-Improvement, SWE-Universe, SWE-TRACE, daVinci-Env, TermiGen, ENVS, RAGEN, VAGEN |
...
| Study GUI/VLM agents | OSWorld, AndroidWorld, MobileGym, MCPWorld, OmniACT | OpenCUA, UI-TARS, Xiaomi-GUI-0, FineState-Bench, VeriGUI / Action-Effect Verification, UI-KOBE, Mobile-Agent-v3.5 / GUI-Owl-1.5, ATMem / STR-GRPO, Task-State Representation / TSR, MacAgentBench, GUI vs. CLI Execution Benchmark, GUIGuard-Bench, OSWorld-Human, ChainWorld, PPT-Eval, ENVS |
...
| Study research agents | MLE-bench, PaperBench, GAIA | D3-Gym, Agentic-Ideation, EurekAgent, AgentBuild / Rietveld Refinement, MDForge, EHR-Complex, Text World Models for LLM Agents, COMAP, Internalizing the Future, Ask the World Before Acting |
...
- AndroidWorld, AndroidDaily, MobileGym, MobileWorld, Xiaomi-GUI-0, FineState-Bench, VeriGUI / Action-Effect Verification, PhoneHarness, Beyond GUI Paradigm / CLI-Advantage, MemGUI-Agent, Mobile-Agent-v3.5 / GUI-Owl-1.5, UI-KOBE, ATMem / STR-GRPO, Task-State Representation / TSR, MemGUI-Bench, STAMP / Memory-World, CAPED, and Teach-and-Repeat.
