...
| Curated resources | 535 |
| Canonical categories | 11 |
| Public runnable resources | 88 |
| Weekly Hot Papers strip | 12 |
| Resources with trajectory assets | 308 |
| Resources with public repositories | 248 |
...
| Frontier signals to watch | OSWorld 2.0, TUA-Bench, Qwen-AgentWorld, WorldEvolver, Fara-1.5, MacAgentBench, GUI vs. CLI Execution Benchmark, ToolBench-X, VisCritic, Autonomous Evaluation for CUA RL, ShareLock, Agent Policy-as-Code Autoformalization, VIGIL, PrincipalBench / Multi-Party Principal Loyalty, MCPPrivacyDetector, TACO, LLM-as-Code Agentic Programming for Agent Harness, Agent JIT Compilation, Claw-R1, TEE-Backed Isolation for Self-Hosted Computer-Use Agents, Memory-Induced Tool-Drift / MEMDRIFT, PhAIL / Physical AI Leaderboard |
