...
Use the Resource Index and Hot Papers page for the full resource set.
...
access. The Featured 12 strip shows the public update date and weekly cadence
used by the Hot Papers document.
...
are derived view fields, not separate canonical source fields.
...
The README and Static Explorer group the 11 canonical categories into broader reader-facing surfaces; the [Resource Index](./others/docs/resource-index.md) is authoritative for canonical category placement. Each section keeps its full inventory in a collapsible year list, while the [Static Explorer](./site/README.md) provides filtering and bilingual browsing.
...
Use the template vocabularies for canonical category, Agent World surface, resource kind, reader paths, source support tags, and source confidence (`official` or `high`). For catalog-ready evidence and exclusion cases, see the [Selection Guide inclusion criteria](./others/docs/selection-guide.md#inclusion-criteria).
